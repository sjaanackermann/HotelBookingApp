...
<body>
    ...
    <div class="field">
        ...
        <p class="control">
            ...
            <hr>
            <input type="checkbox" name="hotel2" value="Ibis Hotel" id="info2"><img id="images" src="images/ibisMain.jpg" alt="Ibis Hotel" width="260px">
            <h3>Ibis Hotel</h3>
            ...
            <hr>
            <input type="checkbox" name="hotel3" value="Hotel Indigo" id="info3"><img id="images" src="images/indigoMain.jpg" alt="Hotel Indigo" width="260px">
            <h3>Hotel Indigo</h3>
            ...
            <hr>
            <input type="checkbox" name="hotel4" value="Sandman Hotel" id="info4"><img id="images" src="images/sandmanMain.jpg" alt="Sandman Hotel" width="260px">
            <h3>Sandman Hotel</h3>
            ...
            <hr>
            <input type="checkbox" name="hotel5" value="Sleeperz Hotel" id="info5"><img id="images" src="images/sleeperzMain.jpg" alt="Sleeperz Hotel" width="260px">
            ...
            <hr>
            <input type="checkbox" name="hotel6" value="Motel One Hotel" id="info6"><img id="images" src="images/motelMain.jpg" alt="Motel One Hotel" width="260px">
            <h3>Motel One</h3>
            ...
            <hr>
            <input type="checkbox" name="hotel7" value="Radisson Red Hotel" id="info7"><img id="images" src="images/radissonMain.jpg" alt="Radisson Red Hotel" width="260px">
            ...
            <hr>
            <input type="checkbox" name="hotel8" value="Residence Inn" id="info8"><img id="images" src="images/residenceMain.jpg" alt="Residence Inn" width="260px">
            <h3>Residence Inn</h3>
            <p id="discrip">
            ...
            <hr>
            <input type="checkbox" name="hotel9" value="Hampton Hotel" id="info9"><img id="images" src="images/hamptonMain.jpg" alt="Hampton Hotel" width="260px">
            <h3>Hampton Hotel</h3>
            ...
            <hr>
            <input type="checkbox" name="hotel10" value="Alexandra Hotel" id="info10"><img id="images" src="images/alexandraMain.jpg" alt="Alexandra Hotel" width="260px">
